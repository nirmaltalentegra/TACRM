...
/* Location: ./application/models/Grade_level_model.php */
...
class Grade_level_model extends CI_Model
{
	...
	$this->db->or_like('grade_level_name', $q);
...
/* End of file Grade_level_model.php */