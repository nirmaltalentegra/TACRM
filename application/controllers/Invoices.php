...
class Invoices extends APP_Controller
{
  ...
  <link rel="stylesheet" href="https://tacrm.talentegra.com/assets/css/components.css">
      ...
      <div class="invoice">
		...
		$invoices = $this->Invoices_model->get_items($row_id);
		$invoices_items = $this->Invoices_model->get_items_list($row_id);
		...
		$html = $this->load->view('invoices/invoices_pdf',$data,TRUE);
