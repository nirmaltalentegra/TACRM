...
class Batches_students extends APP_Controller
{
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (!$this->Batches_students_model->insert($data)) {
    ...
    public function update_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (!$this->Batches_students_model->update($this->input->post('batch_id', TRUE), $data)) {
                $this->session->set_flashdata('error', 'Same name cannot be repeated.');
            } else {
    ...
    public function delete($id)
    {
        ...
        if ($row) {
            ...
            if (!$this->Batches_students_model->delete($id)) {
                $this->session->set_flashdata('error', 'Batches student already exist in its subsections');
            } else {
