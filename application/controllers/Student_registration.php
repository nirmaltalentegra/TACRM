...
class Student_registration extends APP_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('Student_reg_model');
    ...
    {
        $users = $this->Student_reg_model->get_all();

        $data = array(
            'users_data' => $users,
            'title' => 'TRAMS::SCP::Registration',
        );
        $this->_tpl('student_registration/student_reg_list', $data);
    }

    public function read($id)
    {
        $row = $this->Student_reg_model->get_by_id($id);
        if ($row) {
            $data = array(
                'title'  => 'TRAMS::SCP::Registration',
            ...
            $this->_tpl('student_registration/student_reg_read', $data);
        } else {
            $this->session->set_flashdata('error', 'Record Not Found');
            redirect(site_url('student_registration'));
        }
    }
    ...
    public function create()
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('student_registration/create_action'),
            'title'  => 'TRAMS::SCP::Create Student',
        ...
        $this->_tpl('student_registration/student_reg_form', $data);
    }
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Student_reg_model->insert($data);
            ...
            //print_r($output);exit;
            $this->session->set_flashdata('message', 'Student created successfully.Acitvation email has been sent to user to set his password.');
            redirect(site_url('student_registration'));
        }
    }
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('student_registration/update_action'),
                'title'  => 'TRAMS::SCP::Update student',
            ...
            $this->_tpl('student_registration/student_reg_edit', $data);
        } else {
            $this->session->set_flashdata('error', 'Record Not Found');
            redirect(site_url('student_registration'));
        }
    ...
    public function update_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Student_reg_model->update($this->input->post('id', TRUE), $data);
    ...
    public function send_email_verification($id)
    {
        ...
        if ($this->Users_model->sendEmail($receiver)) {
            ...
            $this->load->view('student_reg_list');
