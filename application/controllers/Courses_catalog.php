...
class Courses_catalog extends APP_Controller
{
	...
	public function create_action()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if (!$this->Courses_catalog_model->insert($data)) {
				$this->session->set_flashdata('message', 'Same name cannot be repeated.');
			} else {
	...
	public function update_action()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if (!$this->Courses_catalog_model->update($this->input->post('course_id', TRUE), $data)) {
				$this->session->set_flashdata('message', 'Same name cannot be repeated.');
			} else {
