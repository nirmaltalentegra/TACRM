...
<div class="main-content">
  <section class="section">
    <div class="section-header">
       <h1>Degree_types <small>-Detail list of Degree_types</small></h1>
     ...
     <div class="section-body">
	  <div class="row">
	    ...
	    <div class=" form-group">
			...
			<input type="text" class="form-control " name="degree_type" id="degree_type" placeholder="Degree Type" value="<?php echo $degree_type; ?>" />
	    ...
	    <div class=" form-group">
			...
			<?php echo form_error('updated_at') ?>
                            ...
                            <div class="form-group">
                                    ...
                                    <button class="btn btn-primary" type="button" onclick="window.location.href = '<?php echo base_url('degree_types/'); ?>';">Cancel</button>
