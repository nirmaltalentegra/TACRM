		...
		<div class="section-body">
			<div class="row">
						...
						<form id="frm_edit" class="form-horizontal form-label-left" data-parsley-validate="" action="<?php echo $action; ?>" method="post">
							...
							<div class="card-body">
								...
								<div class=" form-group">
									...
									<input type="date" class="form-control " name="end_date" id="end_date" placeholder="End Date" value="<?php echo isset($end_date) ? set_value('end_date', date('Y-m-d', strtotime($end_date))) : set_value('end_date'); ?>"></input>
			  ...
			  <?php //foreach ($row_course_fee_type as $row)
				//{ 
				?>
					<option <? //= ($row['course_fee_type_id']==$course_fee_type)?'selected':'' 
							?> value="<?php //echo $row['course_fee_type_id'];
										?>" ><?php //echo $row['course_fee_type']; 
												?></option>
				<?php
				//}
				?> 
