...
?>  
     ...
     <div class="section-body">
	  <div class="row">
	    ...
	    <div class=" form-group">
			 <label class="control-label " for="varchar">Grade Level Name</label>
         
			<input type="text" class="form-control " name="grade_level_name" id="grade_level_name" placeholder="Grade Level Name" value="<?php echo $grade_level_name; ?>" />
			<?php echo form_error('grade_level_name') ?>
