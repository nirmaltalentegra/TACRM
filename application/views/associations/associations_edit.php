...
<div class="main-content">
  <section class="section">
    <div class="section-header">
       <h1>Associations <small>-Detail list of Associations</small></h1>
...
<input type="hidden"  name="id" name="id" value="<?php echo $id; ?>" />
      <div class="card-header">
	    ...
	    <div class=" form-group">
			...
			<input type="text" class="form-control " name="association" id="association" placeholder="Association" value="<?php echo $association; ?>" />
	    ...
	    <div class=" form-group">
			...
			<?php echo form_error('updated_at') ?>
                            ...
                            <div class="form-group">
                                    ...
                                    <button class="btn btn-primary" type="button" onclick="window.location.href = '<?php echo base_url('associations/'); ?>';">Cancel</button>
