...
<div class="main-content">
  <section class="section">
    <div class="section-header">
       <h1>Status <small>-Detail list of Status</small></h1>
...
<input type="hidden"  name="status_id" name="status_id" value="<?php echo $status_id; ?>" />
      <div class="card-header">
	    ...
	    <div class=" form-group">
			 <label class="control-label " for="varchar">Status</label>
	    ...
	    <div class=" form-group">
			 <label class="control-label " for="int">Status Type</label>
	 ...
	 <div class="ln_solid"></div>
                            <div class="form-group">
                                    ...
                                    <button class="btn btn-primary" type="button" onclick="window.location.href = '<?php echo base_url('status/'); ?>';">Cancel</button>
