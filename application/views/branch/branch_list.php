...
<div class="row">
	    ...
	    <tbody>
		    ...
		    <td width="200px">
			<?php 
			echo '<a class="btn btn-icon btn-sm btn-info" href="'.site_url('branch/read/'.$branch->branch_id).'" title="Details">';
			echo '<i class="fas fa-info-circle"></i>'; 
            echo '</a>&nbsp;'; 
			
			echo '<a class="btn btn-icon btn-sm btn-primary" href="'.site_url('branch/update/'.$branch->branch_id).'" title="Edit">';
			echo '<i class="far fa-edit"></i>'; 
            echo '</a>&nbsp;';
			
			echo '<a class="btn btn-icon btn-sm btn-danger" href="'.site_url('branch/delete/'.$branch->branch_id).'" title="Delete" onclick="javasciprt: return confirm(\'Are You Sure ?\')">';
