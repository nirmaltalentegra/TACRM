...
<div class="main-content">
  <section class="section">
    <div class="section-header">
       <h1>Sub_levels <small>-Detail list of Sub_levels</small></h1>
...
?>  
     ...
     <div class="section-body">
	  <div class="row">
	    ...
	    <div class=" form-group">
			 <label class="control-label " for="varchar">Level Name</label>
         
			<input type="text" class="form-control " name="level_name" id="level_name" placeholder="Level Name" value="<?php echo $level_name; ?>" />
	    ...
	    <div class=" form-group">
			...
			<?php echo form_error('updated_at') ?>
                            ...
                            <div class="form-group">
                                    ...
                                    <button class="btn btn-primary" type="button" onclick="window.location.href = '<?php echo base_url('sub_levels/'); ?>';">Cancel</button>
