...
<div class="main-content">
  <section class="section">
    <div class="section-header">
       <h1>Grades <small>-Detail list of Grades</small></h1>
...
<input type="hidden"  name="grade_id" name="grade_id" value="<?php echo $grade_id; ?>" />
      <div class="card-header">
	    ...
	    <div class=" form-group">
			 <label class="control-label " for="varchar">Grade Name</label>
           
			<input type="text" class="form-control " name="grade_name" id="grade_name" placeholder="Grade Name" value="<?php echo $grade_name; ?>" />
			<?php echo form_error('grade_name') ?>
	 ...
	 <div class="ln_solid"></div>
                            <div class="form-group">
                                    ...
                                    <button class="btn btn-primary" type="button" onclick="window.location.href = '<?php echo base_url('grades/'); ?>';">Cancel</button>
