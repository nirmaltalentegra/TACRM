<ul class="nav nav-tabs">
        ...
        <li class="nav-item"><a class="nav-link" href="#org" data-toggle="tab">Organization</a></li>
        <li class="nav-item"><a class="nav-link" href="#staff" data-toggle="tab">Staff</a></li>
        <li class="nav-item"><a class="nav-link" href="#dept" data-toggle="tab">Dept</a></li>
    </ul>
