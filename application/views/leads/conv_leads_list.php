 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Leads
        <small>Converted Leads List</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo base_url('leads'); ?>">Leads</a></li>
        <li class="active">Converted Leads List</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      ...
      <div class="box">        
        ...
        <div class="page-header clearfix">
            <div class="pull-left"><h2 style="margin-top:0px">Converted Leads List</h2></div>
            <div class="pull-right">                
                <?php echo anchor('leads#', '<i class="fa fa-print"></i> PDF', 'class="btn btn-danger"'); ?>
                <?php echo anchor('leads#', '<i class="fa fa-file-excel-o"></i> Excel', 'class="btn btn-success"'); ?>
            </div>
        </div>
	    ...
	    <tbody>
		    ...
		    <td><?php echo date($date_format,strtotime($leads->created)) ?></td>
		    ...
		    <td class="hide" style="text-align:center" width="200px">
                    <?php 
