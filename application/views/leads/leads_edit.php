...
<!-- =============================================== -->
  ...
  <div class="content-wrapper">
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="fa-icons">                
                  ...
                  <form id="frm_edit" name="frm_edit" class="form-horizontal form-label-left" data-parsley-validate="" action="<?php echo $action; ?>" method="post">
                      <input type="hidden"  name="lead_id" name="lead_id" value="<?php echo $lead_id; ?>" />
    <div class="row">
    ...
    <div class="row">
        ...
        <?php 
        if($cust_type != '6') { $hide='';} else {$hide='hide';}
        ?>
        <div class="col-md-6 col-sm-6 col-xs-12">
            <div class=" form-group <?php echo $hide; ?>" id="div_comp_name">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="varchar">Company Name</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" class="form-control col-md-7 col-xs-12" name="comp_name" id="comp_name" placeholder="Company Name" value="<?php echo $comp_name; ?>" />
    ...
    <?php 
        if($source_id == '6') { $shide='';} else {$shide='hide';}
    ?>
    <h4 class="page-header">Other Info</h4>
    <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12">
            <div class=" form-group <?php echo $shide; ?>" id="div_ref_name">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <div class=" form-group <?php echo $shide; ?>" id="div_ref_mobile">
    ...
    <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo (($status == 6)?'':'hide')?>" id="div_lost_reason">
            <div class=" form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo (($status == 6)?'':'hide')?>" id="div_lost_remark">
            <div class=" form-group">
