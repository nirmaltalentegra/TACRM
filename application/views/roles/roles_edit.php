...
<div class="main-content">
  <section class="section">
    <div class="section-header">
       <h1>Roles <small>-Detail list of Roles</small></h1>
...
<input type="hidden"  name="id" name="id" value="<?php echo $id; ?>" />
      <div class="card-header">
	    ...
	    <div class=" form-group">
			 <label class="control-label " for="varchar">User Role</label>
			...
			<?php echo form_error('user_role') ?>
                            ...
                            <div class="form-group">
                                    ...
                                    <button class="btn btn-primary" type="button" onclick="window.location.href = '<?php echo base_url('roles/'); ?>';">Cancel</button>
