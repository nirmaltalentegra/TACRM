...
CREATE TABLE `batches` (
  ...
  UNIQUE KEY `duplicate_entries` (`batch_title`),
  KEY `course_name` (`course_id`),
  KEY `faculty_id` (`faculty_id`),
  KEY `branch_id` (`branch_id`),
  KEY `dasa` (`category_id`),
  CONSTRAINT `dasa` FOREIGN KEY (`category_id`) REFERENCES `customers` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `batches` VALUES (1,3,16,'Batch001','Blockchain Ethereum & Hyperledger - Jul10','Blockchain Ethereum & Hyperledger - Jul10',60,6,1,2,'2021-06-10 00:00:00','2021-08-03 21:47:06','1,7',0,5,0,1,1,8000.00,1,16000.00,8,1,NULL,1,NULL,'2021-07-11 11:51:44','2021-07-11 11:51:44'),(2,3,16,'Batch002','Test Batch - Ignore','Test Batch - Ignore',44,7,1,2,'2021-07-24 00:00:00','2021-08-03 21:47:12','1,7',0,5,0,1,1,1575.00,1,16000.00,7,1,NULL,1,NULL,'2021-07-23 11:29:38','2021-07-23 11:29:38'),(3,3,16,'Batch003','test','test',30,1,2,1,'2021-07-30 00:00:00','2021-08-03 21:47:16','1,2,3',0,10,0,1,1,20000.00,1,16000.00,7,1,NULL,1,NULL,'2021-07-29 18:35:39','2021-07-29 18:35:39');
...
CREATE TABLE `batches_students` (
  ...
  KEY `constaint_batch` (`batch_id`),
  CONSTRAINT `constaint_batch` FOREIGN KEY (`batch_id`) REFERENCES `batches` (`batch_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `batches_students` VALUES (1,1,5,NULL,NULL,NULL,NULL,NULL,'No',0,'2021-07-11 11:52:54','2021-08-03 21:48:39'),(2,1,6,NULL,NULL,NULL,NULL,NULL,'No',0,'2021-07-11 11:53:48','2021-07-21 13:48:21'),(3,2,7,NULL,NULL,NULL,NULL,NULL,'No',0,'2021-07-23 11:30:11','2021-07-23 11:32:39'),(4,1,8,NULL,NULL,NULL,NULL,NULL,'No',0,'2021-07-24 13:03:14','2021-07-24 13:14:04'),(5,2,9,NULL,NULL,NULL,NULL,NULL,'No',0,'2021-07-24 14:50:04','2021-07-24 14:51:27'),(6,3,10,NULL,NULL,NULL,NULL,NULL,'No',0,'2021-07-29 18:38:12','2021-08-03 21:40:51'),(7,1,11,NULL,NULL,NULL,NULL,NULL,'No',0,'2021-07-30 11:29:34','2021-08-03 21:40:56'),(8,3,12,NULL,NULL,NULL,NULL,NULL,'No',0,'2021-08-06 03:35:23','0000-00-00 00:00:00');
...
CREATE TABLE `branch` (
  ...
  UNIQUE KEY `duplicate_entries` (`branch_name`),
...
CREATE TABLE `categories` (
  ...
  UNIQUE KEY `Duplicate_entry` (`category_name`)
...
INSERT INTO `categories` VALUES (3,0,'Language Learning',1,'2016-06-27 18:21:04','2016-06-27 18:21:04'),(4,0,'IT Courses',1,'2016-06-27 18:21:04','2016-06-27 18:21:04'),(7,0,'Online Courses',1,'2016-06-27 18:21:04','2016-06-27 18:21:04'),(8,0,'Certificate',1,'2016-06-27 18:21:04','2016-06-27 18:21:04'),(10,8,'Long term course',1,'2016-06-27 18:21:04','2016-06-28 00:30:09'),(11,10,'short term course',1,'2016-06-28 00:24:31','2016-06-28 00:29:57'),(15,0,'Webinars',1,'2021-07-02 10:37:48','0000-00-00 00:00:00'),(17,0,'Cloud',1,'2021-07-10 21:42:24','0000-00-00 00:00:00'),(19,4,'Blockchain',1,'2021-07-30 16:35:30','2021-07-30 23:22:20'),(23,17,'DevOps',0,'2021-08-04 10:33:36','2021-08-04 11:05:56'),(25,17,'DevOps1',1,'2021-08-04 12:32:28','0000-00-00 00:00:00'),(29,23,'test',1,'2021-08-05 06:43:24','0000-00-00 00:00:00'),(30,4,'test1123',1,'2021-08-05 07:55:36','2021-08-08 10:49:33'),(50,4,'newtest',1,'2021-08-07 12:56:58','0000-00-00 00:00:00');
...
CREATE TABLE `courses_catalog` (
  ...
  UNIQUE KEY `duplicate_entries` (`course_name`),
  KEY `constraint_customerid` (`category_id`),
  CONSTRAINT `constraint_customerid` FOREIGN KEY (`category_id`) REFERENCES `categories` (`category_id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `courses_catalog` VALUES (3,17,'BC101','BC101 - Blockchain Foundation (Ethereum & Hyperledger)','Blockchain Foundation (Ethereum & Hyperledger)','Blockchain Foundation (Ethereum & Hyperledger)','16',1,NULL,16000.00,1,1,'2021-07-29 12:32:50','',1,'2021-07-11 11:33:55','2021-07-30 15:21:31'),(4,17,'0003','AWS Training','Cloud','AWS','16 Sessions',1,NULL,12500.00,NULL,1,NULL,'',1,'2021-07-31 07:08:28','2021-07-30 15:21:31'),(5,17,'nil','DevOps','DevOps-Foundation','Introduction to DevOps\r\nBenefits of working in a DevOps environment\r\nDevOps Lifecycle\r\nDevOps Stages\r\nDevOps Delivery Pipeline','8 Sessions',2,NULL,0.00,NULL,1,NULL,'',1,'2021-08-04 09:53:33','0000-00-00 00:00:00');
...
INSERT INTO `customers` VALUES (1,'1','Tippanna','M','Pawar','Old Hubli','vrl',2147483647,'tmpawar66@gmail.com','hubli','2021-07-29 04:54:56','2021-07-29 04:54:56',1),(3,'1','Asmitha','R','Shetty','Sai Ram','3D solutions',2147483647,'asmitharshetty@gmail.com','Mangalore','2021-07-29 10:31:38','2021-07-29 10:31:38',1),(4,'1','Srini','d','Vasa','Welcome to india','Tamilnadu',44214111,'vivekra@digitalq.net','Chemmao','2021-07-30 22:53:50','2021-07-30 22:53:50',1),(5,'1','Nivedita','gfhfgh','Shah','gfhgfhgfh','3D solutions',236598789,'niv@test.com','Mangalore','2021-08-02 06:18:26','2021-08-02 06:18:26',1),(7,'2','Pamela','','S','test','Pam & co.',2147483647,'pam@test.com','test','2021-08-08 09:15:23','2021-08-08 09:15:23',1);
...
INSERT INTO `invoices` VALUES (0,1,1,5,53,0,53,0,0,'2021-07-31 15:16:58','2021-07-31 15:16:58',1,'2021-07-31 00:00:00','dsfdsf','dfdsf',' dfds'),(2,NULL,1,NULL,NULL,0,NULL,0,0,'2021-07-31 14:15:29','2021-07-31 14:15:29',1,'2021-07-31 00:00:00','dsfd dsf dfda dff','dsfaf',' safdadsfdfdf'),(3,NULL,1,6,20,20,0,0,0,'2021-08-01 08:11:54','2021-08-01 08:11:54',1,'2021-07-31 00:00:00','dsfds','dfsdfdf','dsfdffadfdfdf'),(5,5,1,41,1033,1000,33,200,0,'2021-08-03 11:03:40','2021-08-03 11:03:40',1,'2021-08-03 00:00:00','adsfads','ad','fda'),(6,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `items` VALUES (1,NULL,NULL,1,NULL,'ttter',NULL,5,5,25,NULL,NULL,NULL,1,'2021-07-31 14:15:29','2021-08-01 08:12:52','dsfaf'),(2,NULL,NULL,1,NULL,'weqwe',NULL,4,4,16,NULL,NULL,NULL,1,'2021-07-31 14:15:29','2021-07-31 14:15:29','dsfaf'),(3,NULL,NULL,1,NULL,'dsad',NULL,5,5,25,NULL,NULL,NULL,1,'2021-07-31 14:15:29','2021-07-31 14:15:29','dsfaf'),(4,1,NULL,1,NULL,'dsfds',NULL,3,3,9,NULL,NULL,NULL,1,'2021-07-31 15:16:58','2021-07-31 15:16:58','dfdsf'),(5,1,NULL,1,NULL,'dff',NULL,2,22,44,NULL,NULL,NULL,1,'2021-07-31 15:16:58','2021-07-31 15:16:58','dfdsf'),(7,3,NULL,1,NULL,'fdsfd',NULL,4,4,16,NULL,NULL,NULL,1,'2021-07-31 15:30:19','2021-07-31 15:30:19','fafsdfad'),(8,3,NULL,1,NULL,'dfdsf',NULL,2,2,4,NULL,NULL,NULL,1,'2021-07-31 15:33:09','2021-07-31 15:33:09','fafsdfad'),(9,3,NULL,1,NULL,'fdsfd',NULL,4,4,16,NULL,NULL,NULL,1,'2021-07-31 15:33:09','2021-07-31 15:33:09','fafsdfad'),(10,5,NULL,1,NULL,'dfdf',NULL,4,32,128,NULL,NULL,NULL,1,'2021-08-03 11:03:40','2021-08-03 11:03:40','ad'),(11,5,NULL,1,NULL,'dfd',NULL,4,4,16,NULL,NULL,NULL,1,'2021-08-03 11:03:40','2021-08-03 11:03:40','ad'),(12,5,NULL,1,NULL,'dfd',NULL,33,33,1089,NULL,NULL,NULL,1,'2021-08-03 11:03:40','2021-08-03 11:03:40','ad');
...
DROP TABLE IF EXISTS `new_invoice`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `new_invoice` (
  `id` int NOT NULL AUTO_INCREMENT,
  `invoice_no` varchar(190) NOT NULL,
  `invoice_from` text NOT NULL,
  `invoice_to` text NOT NULL,
  `invoice_to_label` varchar(190) NOT NULL,
  `invoice_ship` text NOT NULL,
  `invoice_ship_label` varchar(190) NOT NULL,
  `invoice_date` date NOT NULL,
  `invoice_date_label` varchar(190) NOT NULL,
  `invoice_payment_terms` varchar(190) NOT NULL,
  `invoice_payment_terms_label` varchar(190) NOT NULL,
  `invoice_due_date` date NOT NULL,
  `invoice_due_date_label` varchar(190) NOT NULL,
  `invoice_notes` text NOT NULL,
  `invoice_notes_label` varchar(190) NOT NULL,
  `invoice_terms` text NOT NULL,
  `invoice_terms_label` varchar(190) NOT NULL,
  `invoice_subtotal` varchar(190) NOT NULL,
  `invoice_subtotal_label` varchar(190) NOT NULL,
  `invoice_tax` varchar(190) NOT NULL,
  `invoice_tax_label` varchar(190) NOT NULL,
  `invoice_tax_type` varchar(190) NOT NULL,
  `invoice_discount` varchar(190) NOT NULL,
  `invoice_discount_label` varchar(190) NOT NULL,
  `invoice_discount_type` varchar(190) NOT NULL,
  `invoice_shipping` varchar(190) NOT NULL,
  `invoice_shipping_label` varchar(190) NOT NULL,
  `invoice_total` varchar(190) NOT NULL,
  `invoice_total_label` varchar(190) NOT NULL,
  `invoice_amountpaid` varchar(190) NOT NULL,
  `invoice_amountpaid_label` varchar(190) NOT NULL,
  `invoice_balance_due` varchar(190) NOT NULL,
  `invoice_balance_due_label` varchar(190) NOT NULL,
  `invoice_status` varchar(190) NOT NULL,
  PRIMARY KEY (`id`)
...
LOCK TABLES `new_invoice` WRITE;
/*!40000 ALTER TABLE `new_invoice` DISABLE KEYS */;
INSERT INTO `new_invoice` VALUES (1,'1','Test','Test','Bill To','Test','Ship To','2021-08-06','Date','Pay','Payment Terms','2021-08-20','Due Date','Test','Notes','Test','Terms','290','Subtotal','10','Tax ($)','Flat','5','Discount ($)','Flat','2','Shipping','297','Total','','Amount Paid','297','Balance Due','1'),(2,'1','Test User','Test User','Bill To','Test User','Ship To','2021-08-07','Date','Pay','Payment Terms','2021-08-12','Due Date','','Notes','','Terms','240','Subtotal','10','Tax ($)','Flat','5','Discount ($)','Flat','10','Shipping','255','Total','55','Amount Paid','200','Balance Due','1'),(3,'1','Talentegra','Asmitha','Bill To','Mangalore','Address','2021-08-07','Date','Pay by 31/08/2021','Payment Terms','2021-08-31','Due Date','','Notes','','Terms','18000','Subtotal','2','Tax (%)','Percent','10','Discount (%)','Percent','','Shipping','16560','Total','15000','Amount Paid','1560','Balance Due','1'),(4,'1','Talentegra','Asmitha','Bill To','Mangalore','Address','2021-08-07','Date','Pay by 31/08/2021','Payment Terms','2021-08-31','Due Date','','Notes','','Terms','18000','Subtotal','2','Tax (%)','Percent','10','Discount (%)','Percent','','Shipping','16560','Total','15000','Amount Paid','1560','Balance Due','1'),(5,'1','Talentegra','Asmitha','Bill To','Mangalore','Address','2021-08-07','Date','Pay by 31/08/2021','Payment Terms','2021-08-31','Due Date','NA','Notes','NA','Terms','18000','Subtotal','2','Tax (%)','Percent','10','Discount (%)','Percent','','Shipping','16560','Total','15000','Amount Paid','1560','Balance Due','1'),(6,'1','Talentegra','Asmitha','Bill To','Mangalore','Address','2021-08-07','Date','Pay by 31/08/2021','Payment Terms','2021-08-31','Due Date','NA','Notes','NA','Terms','18000','Subtotal','2','Tax (%)','Percent','10','Discount (%)','Percent','','Shipping','16560','Total','15000','Amount Paid','1560','Balance Due','1'),(7,'1','Test','Test','Bill To','Test','Ship To','2021-08-07','Date','Pay','Payment Terms','2021-08-13','Due Date','Notes','Notes','Notes','Terms','100','Subtotal','10','Tax ($)','Flat','','Discount ($)','Flat','','Shipping','110','Total','','Amount Paid','110','Balance Due','1'),(8,'1','Test','Test','Bill To','Test','Ship To','2021-08-07','Date','Pay','Payment Terms','2021-08-13','Due Date','Notes','Notes','Notes','Terms','100','Subtotal','10','Tax ($)','Flat','','Discount ($)','Flat','','Shipping','110','Total','','Amount Paid','110','Balance Due','1');
/*!40000 ALTER TABLE `new_invoice` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `new_invoice_items`
--

DROP TABLE IF EXISTS `new_invoice_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `new_invoice_items` (
  `id` int NOT NULL AUTO_INCREMENT,
  `invoice_id` int NOT NULL,
  `invoice_item` varchar(190) NOT NULL,
  `invoice_qty` varchar(190) NOT NULL,
  `invoice_rate` varchar(190) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `new_invoice_items`
--

LOCK TABLES `new_invoice_items` WRITE;
/*!40000 ALTER TABLE `new_invoice_items` DISABLE KEYS */;
INSERT INTO `new_invoice_items` VALUES (1,1,'Item1','1','150'),(2,1,'Item2','2','70'),(3,2,'Item1','1','100'),(4,2,'Item2','2','70'),(5,3,'Consultation','1','18000'),(6,4,'Consultation','1','18000'),(7,5,'Consultation','1','18000'),(8,6,'Consultation','1','18000'),(9,7,'Item1','1','100'),(10,8,'Item1','1','100');
/*!40000 ALTER TABLE `new_invoice_items` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `profile_education` VALUES (1,'test','intermediate','test','2021-08-07','2021-08-14','SME','test','test');
/*!40000 ALTER TABLE `profile_education` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `profile_professional`
--

DROP TABLE IF EXISTS `profile_professional`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `profile_professional` (
  `profile_professional_id` int NOT NULL AUTO_INCREMENT,
  `organisation_name` varchar(255) NOT NULL,
  `designation` varchar(255) NOT NULL,
  `from_date` date NOT NULL,
  `to_date` date NOT NULL,
  `prof_association` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `job_description` varchar(255) NOT NULL,
  PRIMARY KEY (`profile_professional_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `profile_professional`
--

LOCK TABLES `profile_professional` WRITE;
/*!40000 ALTER TABLE `profile_professional` DISABLE KEYS */;
INSERT INTO `profile_professional` VALUES (1,'test','Beginners','2021-08-08','2021-08-07','Beginners','job');
/*!40000 ALTER TABLE `profile_professional` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `profile_subjects`
--
...
CREATE TABLE `profile_subjects` (
  `profile_subject_id` int NOT NULL AUTO_INCREMENT,
  `subject_id` int NOT NULL,
  `from_level` varchar(255) NOT NULL,
  `to_level` varchar(255) NOT NULL,
  PRIMARY KEY (`profile_subject_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `profile_subjects`
--

LOCK TABLES `profile_subjects` WRITE;
/*!40000 ALTER TABLE `profile_subjects` DISABLE KEYS */;
INSERT INTO `profile_subjects` VALUES (1,0,'intermediate','intermediate'),(2,0,'intermediate','Beginners'),(3,0,'Beginners','Beginners'),(4,37,'SME','Beginners');
/*!40000 ALTER TABLE `profile_subjects` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `profiles` (
  ...
  `expert_level` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `availablity` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `profiles` VALUES (30,101,'Sayooj','Sayooj Company','Math Reasoning Teacher','Name','2021-06-01 15:09:17','2021-06-01 15:11:19','Female','1990-03-17','Math Reasoning','Mangalore, India','123456','[{\"subject\":28,\"from_level\":\"2\",\"to_level\":\"3\"},{\"subject\":29,\"from_level\":\"2\",\"to_level\":\"3\"},{\"subject\":30,\"from_level\":\"2\",\"to_level\":\"3\"}]','[{\"institution\":\"Nehru College of Engineering\",\"deg_type\":\"5\",\"deg_name\":\"B.Tech\",\"startdate\":\"2016-05-01\",\"enddate\":\"2018-03-06\",\"association\":\"3\",\"speciality\":\"Math Reasoning\",\"score\":\"88\"}]','[{\"organisation\":\"St.Thomas\",\"designation\":\"Math and aptitude tutor\",\"e_startdate\":\"2018-03-12\",\"e_enddate\":\"2020-06-22\",\"association\":\"1\",\"job_description\":\"My Job is teaching Math and aptitude for students\"}]','[{\"i_charge\":\"Weekly\",\"min_fee\":\"400\",\"max_fee\":\"500\",\"fee_details\":\"does not vary\",\"tot_exp\":\"2\",\"online_exp\":\"1\",\"travel\":\"yes\",\"travel_kms\":\"12\",\"avail_online_teach\":\"Yes\",\"digital_pen\":\"Yes\",\"help_homework_assig\":\"Yes\",\"currently_emp\":\"No\",\"oppor_interest\":\"full_time\"}]','[{\"profile_des\":\"I am following the type of teaching style which is mostly adaptable in real life and will help you to easily understand. I am also focusing on makeing students prepare to compete in many comparative exams so that it can be very useful for them.\",\"one_acc\":\"yes\"}]',NULL,NULL,NULL,'Unverified','','','','','','',1),(37,181,NULL,NULL,NULL,NULL,'2021-07-15 14:55:01','2021-08-06 09:24:24','Female','2021-08-02','ewewr','wqwwqe','575014','',NULL,NULL,NULL,NULL,'PAN Card','1628241840.table.png','table.png','Unverified','','','','','','',1),(38,141,NULL,NULL,NULL,NULL,'2021-07-16 18:07:39','2021-07-16 18:07:39',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Unverified','','','','','','',1),(39,142,NULL,NULL,NULL,NULL,'2021-07-16 18:09:51','2021-07-16 18:09:51',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Unverified','','','','','','',1),(40,143,NULL,NULL,NULL,NULL,'2021-07-17 13:55:44','2021-07-17 13:55:44',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Unverified','','','','','','',1),(41,150,NULL,NULL,NULL,NULL,'2021-07-20 13:16:34','2021-07-20 13:17:05','Female','2021-07-05','Software',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'PAN Card','1626787025.award2.jpg','award2.jpg','Unverified','','','','','','',1),(42,164,NULL,NULL,NULL,NULL,'2021-07-20 14:55:57','2021-07-20 14:55:57',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Unverified','','','','','','',1),(43,148,'Tp demo','afadasdsa','fsd','Name','2021-07-21 15:26:27','2021-07-21 15:44:01','Male','2021-07-21','dsdf df','dsf',NULL,'[{\"subject\":33,\"from_level\":\"1\",\"to_level\":\"2\"}]','[{\"institution\":\"sdfads df\",\"deg_type\":\"2\",\"deg_name\":\"dfsf\",\"startdate\":\"2021-07-21\",\"enddate\":\"2021-07-21\",\"association\":\"1\",\"speciality\":\"fdf\",\"score\":\"dfdf\"}]',NULL,NULL,NULL,'PAN Card','1626882220.Desktop screensh.png','Desktop screensh.png','Unverified','','','','','','',1),(44,148,'Tp demo','afadasdsa','fsd','Name','2021-07-21 15:41:10','2021-07-21 15:44:01',NULL,NULL,NULL,'dsf',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Unverified','','','','','','',1),(45,166,NULL,NULL,NULL,NULL,'2021-07-22 09:40:21','2021-07-22 09:40:21',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Unverified','','','','','','',1),(46,168,NULL,NULL,NULL,NULL,'2021-07-23 17:52:22','2021-07-23 17:52:22',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Unverified','','','','','','',1),(47,169,NULL,NULL,NULL,NULL,'2021-07-23 23:31:40','2021-07-23 23:31:40',NULL,NULL,NULL,NULL,NULL,'[{\"subject\":2,\"from_level\":\"1\",\"to_level\":\"1\"}]',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Unverified','','','','','','',1),(48,171,NULL,NULL,NULL,NULL,'2021-07-24 13:55:51','2021-07-24 13:55:51',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Unverified','','','','','','',1),(51,187,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Pan card','Pan',NULL,'Unverified','skills','expert level','certification','cost_per_hr','availabliity','test bank',1),(52,188,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Driving License','Driving',NULL,'Unverified','skillssssssssssss','intermediate','certificationssssss','costssssssssssssss','availabliitysssssss','abcd test bankssssssssssssss',1),(56,197,'Sangeetha',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Pan card','PAN',NULL,'Unverified','skills','intermediate','cert','coast','availabliitysssssss','test',1),(60,201,'Sangeetha1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Aadhar Card','adhar',NULL,'Unverified','skills1','intermediate','cert1','cost1','ava1','bank1bank',1),(61,202,'test',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Pan card','Pan',NULL,'Unverified','skil','Beginners','test','cost','ava','bank',1),(62,203,'test',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Pan card','PAn',NULL,'Unverified','test','Beginners','test','test','test','bank',1),(63,204,'Vivek',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Pan card','BDTP2345W',NULL,'Unverified','Php','Beginners','NA','500','Sunday','z€z€xz€zx',1),(64,205,'supeetha',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Pan card','pan',NULL,'Unverified','skill','intermediate','test','cost','yes','bank',1);
...
INSERT INTO `tbl_payments` VALUES (1,129,1,3,'2021-07-11 10:30:44',100,'','2021-07-11 10:30:44'),(2,131,2,1,'2021-07-11 11:08:38',1000,'','2021-07-11 11:08:38'),(3,132,3,1,'2021-07-11 11:09:25',2500,'','2021-07-11 11:09:25'),(4,133,4,4,'2021-07-11 11:10:20',3000,'','2021-07-11 11:10:20'),(5,133,4,4,'2021-07-08 00:00:00',7000,'Paid INR 7000','2021-07-11 11:18:01'),(6,134,5,3,'2021-07-11 11:52:54',500,'','2021-07-11 11:52:54'),(27,135,6,3,'2021-07-20 00:00:00',120,'Notes','2021-07-20 17:46:51'),(28,135,6,3,'2021-07-20 00:00:00',120,'Notes','2021-07-20 17:46:51'),(29,135,7,3,'2021-07-23 11:30:11',500,'','2021-07-23 11:30:11'),(30,135,7,3,'2021-07-23 00:00:00',500,'Wired Transfer','2021-07-23 11:30:57'),(31,135,7,3,'2021-07-22 00:00:00',575,'Done','2021-07-23 11:31:52'),(32,170,8,3,'2021-07-24 13:03:14',1200,'','2021-07-24 13:03:14'),(33,172,9,3,'2021-07-24 14:50:04',1000,'','2021-07-24 14:50:04'),(34,176,10,3,'2021-07-29 18:38:12',12000,'','2021-07-29 18:38:12'),(35,174,11,3,'2021-07-30 11:29:34',2500,'','2021-07-30 11:29:34'),(36,170,8,3,'0000-00-00 00:00:00',0,'','2021-07-30 23:39:32'),(37,171,12,3,'2021-08-06 03:35:23',1000,'','2021-08-06 03:35:23');
...
-- Dump completed on 2021-08-09  3:43:45
