...
<input type="hidden"  name="interest_level_id" name="interest_level_id" value="<?php echo $interest_level_id; ?>" />
      <div class="card-header">
                <h4>Interest_level</h4>
              </div>
              <div class="card-body">
	    <div class=" form-group">
			 <label class="control-label " for="varchar">Interest Level</label>
           
			<input type="text" class="form-control " name="interest_level" id="interest_level" placeholder="Interest Level" value="<?php echo $interest_level; ?>" />
