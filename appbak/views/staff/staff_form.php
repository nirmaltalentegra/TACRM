...
<div class="main-content">
  <section class="section">
    <div class="section-header">
       <h1>Staff <small>-Detail list of Staff</small></h1>
...
?>  
          ...
          <div class="card">
            ...
            <div class="card-body">
              <ul class="nav nav-tabs" id="myTab2" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="account-tab2" data-toggle="tab" href="#account" role="tab" aria-controls="account" aria-selected="false">Account</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="access-tab2" data-toggle="tab" href="#access" role="tab" aria-controls="access" aria-selected="false">Access</a>
                </li>
				<li class="nav-item">
                  <a class="nav-link" id="permission-tab2" data-toggle="tab" href="#permission" role="tab" aria-controls="access" aria-selected="false">Permission</a>
                </li>
				<li class="nav-item">
                  <a class="nav-link" id="team-tab2" data-toggle="tab" href="#team" role="tab" aria-controls="team" aria-selected="false">Team</a>
                </li>
              </ul>
              ...
              <div class="tab-content tab-bordered" id="myTab3Content">
                ...
                <div class="tab-pane fade" id="access" role="tabpanel" aria-labelledby="access-tab2">
                  <?php $this->load->view('staff/staff_form_tab_2');?>
                </div>
				<div class="tab-pane fade" id="permission" role="tabpanel" aria-labelledby="permission-tab2">
                  <?php $this->load->view('staff/staff_form_tab_3');?>
                </div>
				<div class="tab-pane fade" id="team" role="tabpanel" aria-labelledby="team-tab2">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
          ...
          <a href="<?php echo site_url('staff') ?>" class="btn btn-danger"><i class="fa fa-times"></i> Cancel</a>
        </div>
      </div>
    </form>
</div>
