...
<input type="hidden"  name="course_fee_type_id" name="course_fee_type_id" value="<?php echo $course_fee_type_id; ?>" />
      <div class="card-header">
                <h4>Course_fee_type</h4>
              </div>
              <div class="card-body">
	    <div class=" form-group">
			 <label class="control-label " for="varchar">Course Fee Type</label>
