...
<input type="hidden"  name="batch_id" name="batch_id" value="<?php echo $batch_id; ?>" />
      <div class="card-header">
	    ...
	    <div class=" form-group">
           ...
           <select class="form-control" name="course_id" id="course_id" placeholder="Course Id" >
			  ...
			  <?php foreach ($row_courses as $row)
				{ ?>
					<option <?=($row['course_id']==$course_id)?'selected':'' ?> value="<?php echo $row['course_id'];?>" ><?php echo $row['course_name']; ?></option>
				<?php 
				}
				?>
			  </select>
	    ...
	    <div class=" form-group">
             ...
             <select class="form-control" name="faculty_id" id="faculty_id" placeholder="Faculty Id" >
			  ...
			  <?php foreach ($row_faculty as $row)
				{ ?>
					<option <?=($row['faculty_id']==$faculty_id)?'selected':'' ?>  value="<?php echo $row['faculty_id'];?>" ><?php echo $row['firstname'].' '.$row['lastname']; ?></option>
				<?php 
				}
				?>
			  </select>
	    ...
	    <div class=" form-group">
			 <label class="control-label " for="int">Branch Id</label><select class="form-control" name="branch_id" id="branch_id" placeholder="Branch Id" >
					<option value="0">Select</option>
